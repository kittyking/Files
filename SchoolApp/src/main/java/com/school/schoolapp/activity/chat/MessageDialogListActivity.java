...
public class MessageDialogListActivity extends BaseActivity {
...
//  *****************只有把添加消息的操作放在handler里 刷新才能显示*****************
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_message_dialog_list);
		...
		dialogListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				// TODO Auto-generated method stub
				Intent intent = new Intent(MessageDialogListActivity.this,MessageDetailActivity.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.message_dialog_list, menu);
		return false;
	}
