package com.school.schoolapp.view.refreshlist;
...
public class RListView extends ListView implements OnScrollListener{
	 ...
	 private final static int RELEASE_To_REFRESH = 0;// 下拉过程的状态值  
	    ...
	    private void init(Context context) {  
	        ...
	        headerView = (LinearLayout) inflater.inflate(R.layout.view_refresh_header, null);  
	        

//		     // 从xml中得到GifView的句柄  
//	        gif = (GifView) headerView.findViewById(R.id.gif);  
//		    // 设置Gif图片源  
//			//gif.setGifImage(R.drawable.gif_loading); 
//			//gif.setShowDimension(300, 300); 
//			gif.setGifImageType(GifImageType.COVER);
	        
	        ImageView iv = (ImageView)headerView.findViewById(R.id.gif);
	        Glide.with(context).load(R.drawable.gif_loading).into(iv);
	  
	        //lvHeaderProgressBar = (ProgressBar) headerView.findViewById(R.id.pBar);  
	        ...
	        //if(headerContentHeight == 0){
	        	...
	        	if(width >720 )
		        	headerContentHeight = 240 + 20*densityDpi/160;
	        	else
		        	headerContentHeight = 160 + 20*densityDpi/160;
	        //}
