 ...
 * must implement the
 * {@link GoodsManagerRecommendFragment.OnFragmentInteractionListener} interface
 * to handle interaction events. Use the
 * {@link GoodsManagerRecommendFragment#newInstance} factory method to create an
 * instance of this fragment.
 * 
 */
public class GoodsManagerRecommendFragment extends Fragment {
	 ...
	 * @param param2
	 *            Parameter 2.
	 * @return A new instance of fragment GoodsManagerRecommendFragment.
	 */
	// TODO: Rename and change types and number of parameters
	public static GoodsManagerRecommendFragment newInstance(String param1,
			String param2) {
		GoodsManagerRecommendFragment fragment = new GoodsManagerRecommendFragment();
	...
	public GoodsManagerRecommendFragment() {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v = inflater.inflate(R.layout.fragment_goods_manager_recommend,
				container, false);

		managerLV = (ListView)v.findViewById(R.id.managerLV);
		adapter = new GoodsManagerNotSellAdapter(getActivity(),2);
	...
	public void getListView(final int tag){
		String url = getActivity().getString(R.string.base_url)+getActivity().getString(R.string.workspace_goodmanager_hotsalegoods);
...
AlertDialog.Builder builder = new AlertDialog.Builder(getActivity()).setTitle("取消推荐").setMessage("确定要取消推荐商品？").setPositiveButton("确定", new DialogInterface.OnClickListener() {
								@Override
...
builder.show();
	...
	public void deleteGoods(String ticket,final int index){
		String url = getActivity().getString(R.string.base_url)+getActivity().getString(R.string.workspace_goodmanager_setnohotsalegoods);
		RequestParams params = new RequestParams();
