 ...
 * must implement the
 * {@link GoodsManagerSellingFragment.OnFragmentInteractionListener} interface
 * to handle interaction events. Use the
 * {@link GoodsManagerSellingFragment#newInstance} factory method to create an
 * instance of this fragment.
 * 
 */
public class GoodsManagerSellingFragment extends Fragment{
	 ...
	 * @param param2
	 *            Parameter 2.
	 * @return A new instance of fragment GoodsManagerSellingFragment.
	 */
	// TODO: Rename and change types and number of parameters
	public static GoodsManagerSellingFragment newInstance(String param1,
			String param2) {
		GoodsManagerSellingFragment fragment = new GoodsManagerSellingFragment();
	...
	public GoodsManagerSellingFragment() {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v = inflater.inflate(R.layout.fragment_goods_manager_selling,
				container, false);
		managerLV = (ListView)v.findViewById(R.id.managerLV);
		adapter = new GoodsManagerNotSellAdapter(getActivity(),1);
	...
	public void getListView(final int tag){
		String url = getActivity().getString(R.string.base_url)+getActivity().getString(R.string.workspace_goodmanager_salegoods);
				...
				if(managers.getResult().equals("1")){
					...
					managerLV.setOnItemLongClickListener(new OnItemLongClickListener() {
						...
						public boolean onItemLongClick(AdapterView<?> parent,
							...
							// TODO Auto-generated method stub
AlertDialog.Builder builder = new AlertDialog.Builder(getActivity()).setTitle("下架商品").setMessage("确定要下架商品？").setPositiveButton("确定", new DialogInterface.OnClickListener() {
								@Override
